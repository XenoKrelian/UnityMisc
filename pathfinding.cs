...
public class PathfindingHelper
{
    ...
    [System.Serializable]
    private class BreadthFirstSearchNode
    {
        ...
        public BreadthFirstSearchNode(Vector2Int coodinates, bool isWalkable)
        {
    ...
    public class BreadthFirstSearch
    {
        ...
        Queue<BreadthFirstSearchNode> frontier = new Queue<BreadthFirstSearchNode>();
        Dictionary<Vector2Int, BreadthFirstSearchNode> reached = new Dictionary<Vector2Int, BreadthFirstSearchNode>();

        Vector2Int[] directions = { Vector2Int.right, Vector2Int.left, Vector2Int.up, Vector2Int.down };


        public List<BreadthFirstSearchNode> GetNewPath()
        {
            BreadthFirstSearch();
            return BuildPath();
        }
        ...
        {
            List<BreadthFirstSearchNode> neighbors = new List<BreadthFirstSearchNode>();
            ...
            foreach (BreadthFirstSearchNode neighbor in neighbors)
            {
        ...
        List<BreadthFirstSearchNode> BuildPath()
        {
            List<BreadthFirstSearchNode> path = new List<BreadthFirstSearchNode>();
            BreadthFirstSearchNode currentNode = destinationNode;
